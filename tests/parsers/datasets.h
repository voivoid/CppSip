...
const auto discrete_type   = BoostTestData::make(std::string_view( "text" ), std::string_view( "image" ), std::string_view( "audio" ), std::string_view( "video" ), std::string_view( "application" ) );
